...
const Footer = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_71qfaqr", "template_4oakie3", form.current, {
        publicKey: "UtxQrjFxV36I61IEs",
      })
      .then(
        () => {
          console.log("SUCCESS!");
        ...
        <div className="flex gap-x-15 items-center">
          <div className="w-[60%] bg-[#0F172B] rounded-md p-6">
            ...
            <button
              ...
              className="text-white text-[15px] bg-[#06b6d4] hover:bg-[#06b5d4b6] transition-all duration-400 font-medium font-openSans inline-block py-3 px-6 rounded-md cursor-pointer"
            >
              Send Message
            </button>
          </div>
